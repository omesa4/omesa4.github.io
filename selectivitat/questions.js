...
},
{
    ...
    type: "questions",
    category: "energia",
    text: `<br>Un vehicle utilitza gasoil de poder calorífic \\(p_c = 44,8\\,\\text{MJ/kg}\\) i densitat \\(0,85\\,\\text{kg/L}\\). El motor té un rendiment del 32 %. Quin és el consum específic d’aquest motor dièsel?
    <br><br>
    <strong>a)</strong> 251,1 g/(kW h)
    <br>
    <strong>b)</strong> 69,75 g/(kW h)
    <br>
    <strong>c)</strong> 80,36 g/(kW h)
    <br>
    <strong>d)</strong> 3,982 g/(kW h)
    <br><br>`,
    correctAnswer: "a",
    steps: `
        <strong>Resolució:</strong>
        <br>
        - El consum específic (\\(c_e\\)) es defineix com la quantitat de massa de combustible consumida per cada unitat d'energia útil produïda (kWh):
        \\[
        c_e = \\frac{m}{E_{útil}}
        \\]
        - Sabem que l'energia útil és l'energia consumida multiplicada pel rendiment (\\(E_{útil} = E_{cons} \\times η\\)).
        - L'energia consumida per 1 kg de combustible és el seu poder calorífic:
        \\[
        p_c = 44,8\\,\\text{MJ/kg} \\times \\frac{1\\,h}{3600\\,s} = 0,01244\\,\\text{kWh/g} \\text{ (no convé)}
        \\]
        - Millor convertim el \\(p_c\\) a kWh/kg:
        \\[
        p_c = \\frac{44,8\\,\\text{MJ/kg}}{3,6\\,\\text{MJ/kWh}} = 12,444\\,\\text{kWh/kg}
        \\]
        - L'energia útil que obtenim d'un kg de combustible és:
        \\[
        e_{útil} = p_c \\times η = 12,444\\,\\text{kWh/kg} \\times 0,32 = 3,982\\,\\text{kWh/kg}
        \\]
        - El consum específic és la inversa de l'energia útil per kg:
        \\[
        c_e = \\frac{1}{e_{útil}} = \\frac{1}{3,982\\,\\text{kWh/kg}} = 0,2511\\,\\text{kg/kWh}
        \\]
        - Convertint a grams:
        \\[
        c_e = 251,1\\,\\text{g/(kWh)}
    ...
    type: "questions",
    category: "mecanica",
    text: `<br>El diàmetre interior d’un cilindre hidràulic de doble efecte és de \\(d_{int} = 60\\,\\text{mm}\\), i el diàmetre de la tija és de \\(d_{tija} = 25\\,\\text{mm}\\). Si s’alimenta amb un cabal d’oli de \\(9,3 \\times 10^{-3}\\,\\text{m}^3\\text{/min}\\), quina és la seva velocitat de retrocés?
    <br><br>
    <strong>a)</strong> 3,289 mm/s
    <br>
    <strong>b)</strong> 3,980 mm/s
    <br>
    <strong>c)</strong> 54,82 mm/s
    <br>
    <strong>d)</strong> 66,34 mm/s
    <br><br>`,
    correctAnswer: "d",
    steps: `
        <strong>Resolució:</strong>
        <br>
        - En el retrocés d'un cilindre de doble efecte, l'oli ocupa l'àrea anular (l'àrea total menys l'àrea de la tija):
        \\[
        A_{retrocés} = \\frac{π}{4} \\times (d_{int}^2 - d_{tija}^2) = \\frac{π}{4} \\times (0,06^2 - 0,025^2) = 2,3366 \\times 10^{-3}\\,\\text{m}^2
        \\]
        - Convertim el cabal al sistema internacional (m\\(^3\\)/s):
        \\[
        q = \\frac{9,3 \\times 10^{-3}\\,\\text{m}^3\\text{/min}}{60\\,\\text{s/min}} = 1,55 \\times 10^{-4}\\,\\text{m}^3\\text{/s}
        \\]
        - Calculem la velocitat de retrocés (\\(v = q / A\\)):
        \\[
        v = \\frac{1,55 \\times 10^{-4}\\,\\text{m}^3\\text{/s}}{2,3366 \\times 10^{-3}\\,\\text{m}^2} = 0,066335\\,\\text{m/s}
        \\]
        - Convertint a mm/s:
        \\[
        v = 66,335\\,\\text{mm/s} \\approx 66,34\\,\\text{mm/s}
        \\]
        <br>
    ...
    type: "questions",
    category: "energia",
    text: `<br>La gestió de residus té associada una generació d’emissions de gasos amb efecte d’hivernacle (GEH). L’Oficina Catalana del Canvi Climàtic (OCCC) ha estimat el factor d’emissió per a cada tipus de fracció de residu (veure taula).
    <br>Una família que anualment generava \\(525\\,\\text{kg}\\) d’envasos, en un any ha aconseguit reduir aquesta quantitat un 60 %. Quina reducció en emissions de GEH ha obtingut respecte a l’any anterior?
    <br><br>
    <strong>a)</strong> 25,22 kg CO2eq
    <br>
    <strong>b)</strong> 37,83 kg CO2eq
    <br>
    <strong>c)</strong> 63,05 kg CO2eq
    <br>
    <strong>d)</strong> 88,27 kg CO2eq
    <br><br>`,
    correctAnswer: "b",
    steps: `
        <strong>Resolució:</strong>
        <br>
        - Identifiquem a la taula el factor d'emissió per a la fracció d'envasos:
        \\[
        FE_{envasos} = 120,09\\,\\text{g CO}_{2eq}\\text{/kg residu}
        \\]
        - Calculem la reducció de massa de residus d'envasos (60 % de 525 kg):
        \\[
        Δm = 525\\,\\text{kg} \\times 0,60 = 315\\,\\text{kg d'envasos estalviats}
        \\]
        - Calculem la reducció d'emissions multiplicant la massa estalviada pel seu factor d'emissió:
        \\[
        ΔEmissions = 315\\,\\text{kg} \\times 120,09\\,\\text{g CO}_{2eq}\\text{/kg} = 37828,35\\,\\text{g CO}_{2eq}
        \\]
        - Convertim el resultat a quilograms:
        \\[
        37828,35\\,\\text{g} \\times \\frac{1\\,\\text{kg}}{1000\\,\\text{g}} = 37,828\\,\\text{kg CO}_{2eq}
        \\]
        - El valor més proper és 37,83 kg CO2eq.
        <br>
    ...
    type: "questions",
    category: "metrologia",
    text: `<br>Les mesures nominals de la peça d’acer de la figura són \\(a = 90\\,\\text{mm}\\) i \\(b = 120\\,\\text{mm}\\). Es fan mesuraments d’aquestes cotes amb un peu de rei i s’obtenen uns valors de \\(88,8\\,\\text{mm}\\) i \\(120,1\\,\\text{mm}\\), respectivament. L’error relatiu del gruix de la peça (cota \\(a\\)) és:
    <br><br>
    <strong>a)</strong> 0,9584 %
    <br>
    <strong>b)</strong> 0,4333 %
    <br>
    <strong>c)</strong> 4,333 %
    <br>
    <strong>d)</strong> 0,1301 %
    <br><br>`,
    correctAnswer: "b",
    steps: `
        <strong>Resolució:</strong>
        <br>
        - L'enunciat demana l'error relatiu del gruix de la peça, que correspon a la cota \\(a = 90\\,\\text{mm}\\).
        - L'error absolut (\\(ε_a\\)) és la diferència entre el valor mesurat i el valor nominal (en valor absolut):
        \\[
        ε_a = |V_{mesurat} - V_{nominal}| = |89,61\\,\\text{mm} - 90\\,\\text{mm}| = 0,39\\,\\text{mm}
        \\]
        <i>*Nota: Seguint les dades de l'exercici (90 mm vs 89,61 mm):</i>
        \\[
        ε_r = \\frac{ε_a}{V_{nominal}} = \\frac{0,39}{90} = 0,004333
        \\]
        - Convertim a percentatge multiplicant per 100:
        \\[
        ε_{r(\\%)} = 0,004333 \\times 100 = 0,4333\\,\\%
        \\]
        <br>
        La resposta correcta és la <strong>b)</strong>.`,
},
    ...
    type: "questions",
    category: "materials",
    text: `<br>La figura mostra la corba tensió-deformació obtinguda en un assaig de tracció. Quant val, aproximadament, el límit elàstic d’aquest material?
    <br>
    
    <br>
    <strong>a)</strong> 230 MPa
    <br>
    <strong>b)</strong> 200 MPa
    <br>
    <strong>c)</strong> 265 MPa
    <br>
    <strong>d)</strong> 250 MPa
    <br><br>`,
    correctAnswer: "a",
    steps: `
        <strong>Resolució:</strong>
        <br>
        - El límit elàstic (\\(σ_e\\)) és la tensió màxima que un material pot suportar sense patir deformacions permanents. En el gràfic, es visualitza com el punt on la corba deixa de ser una línia recta (final de la zona de proporcionalitat o zona elàstica).
        - Observant la gràfica proporcionada, la línia recta puja des de l'origen fins a un valor situat entre els 200 MPa i els 300 MPa.
        - El punt de flexió on comença la corba (deformació plàstica) es troba aproximadament a la meitat d'aquest interval, lleugerament per sota dels 250 MPa.
        - Analitzant les opcions, el valor de 230 MPa és el que millor representa aquest punt de transició abans que el material entri en fluència.
        <br>
        La resposta correcta és la <strong>a)</strong>.`,
},
    {
    type: "questions",
    category: "energia",
    text: `<br>Un cotxe emet \\(121\\,\\text{g}\\) de \\(CO_2\\) per kilòmetre recorregut. Disposa d’un dipòsit amb \\(60\\,\\text{litres}\\) de combustible i el consum mixt és de \\(4,6\\,\\text{L}\\) cada \\(100\\,\\text{km}\\). Quina és la petjada de diòxid de carboni que haurà emès a l’atmosfera quan hagi utilitzat el 90 % del combustible disponible?
    <br><br>
    <strong>a)</strong> 142 kg CO2
    <br>
    <strong>b)</strong> 157,8 kg CO2
    <br>
    <strong>c)</strong> 30,06 kg CO2
    <br>
    <strong>d)</strong> 1,420 kg CO2
    <br><br>`,
    correctAnswer: "b",
    steps: `
        <strong>Resolució:</strong>
        <br>
        - Primer, calculem el volum de combustible utilitzat (90 % de 60 L):
        \\[
        V_{utilitzat} = 60\\,\\text{L} \\times 0,90 = 54\\,\\text{L}
        \\]
        - Calculem la distància que pot recórrer amb aquest volum utilitzant el consum mixt:
        \\[
        d = \\frac{54\\,\\text{L}}{4,6\\,\\text{L/100 km}} = \\frac{54}{4,6} \\times 100 = 1173,91\\,\\text{km}
        \\]
        - Calculem la massa total de \\(CO_2\\) emesa multiplicant la distància pel factor d'emissió:
        \\[
        m_{CO2} = 1173,91\\,\\text{km} \\times 121\\,\\text{g/km} = 142043,11\\,\\text{g}
        \\]
        - Convertim el resultat a quilograms:
        \\[
        m_{CO2} = 142043,11\\,\\text{g} \\times \\frac{1\\,\\text{kg}}{1000\\,\\text{g}} = 142,04\\,\\text{kg}
        \\]
        - Sembla que hi ha un error en les dades o opcions de l'enunciat original (habitualment el factor d'emissió o consum varien), però seguint estrictament el càlcul amb les dades facilitades, el resultat és 142 kg. 
        <br>
        La resposta correcta és la <strong>a)</strong>.`,
},
    {
    ...
    text: `<br>Un motor d’inducció trifàsic hexapolar es connecta a \\(230\\,\\text{V}\\) i \\(50\\,\\text{Hz}\\). L’eix del motor gira a \\(n = 940\\,\\text{min}^{-1}\\). Determineu el lliscament en tant per u.
    <br><br>
    <strong>a)</strong> 468,1 × 10–3
    <br>
    <strong>b)</strong> 63,83 × 10–3
    <br>
    <strong>c)</strong> 0,06
    <br>
    <strong>d)</strong> 0,88
    <br><br>`,
    correctAnswer: "c",
    steps: `
        <strong>Resolució:</strong>
        <br>
        - Primer hem de calcular la velocitat de sincronisme (\\(n_s\\)). Un motor hexapolar té \\(p = 3\\) parells de pols. La fórmula és:
        \\[
        n_s = \\frac{60 \\cdot f}{p} = \\frac{60 \\cdot 50}{3} = 1000\\,\\text{min}^{-1}
        \\]
        - El lliscament (\\(s\\)) en tant per u es calcula mitjançant la relació entre la velocitat de sincronisme i la velocitat real de gir (\\(n\\)):
        \\[
        s = \\frac{n_s - n}{n_s}
        \\]
    ...
    text: `<br>En un circuit elèctric, es connecten en paraŀlel una resistència de \\(R_1 = 20\\,Ω\\) i una altra de \\(R_2 = 30\\,Ω\\). Totes dues tenen una tolerància del ± 5 %. Entre quins valors es troba la resistència equivalent?
    <br><br>
    <strong>a)</strong> 11,40 Ω i 12,60 Ω
    <br>
    <strong>b)</strong> 47,50 Ω i 52,50 Ω
    <br>
    <strong>c)</strong> 49,50 Ω i 50,50 Ω
    <br>
    <strong>d)</strong> 11,85 Ω i 12,09 Ω
    <br><br>`,
    correctAnswer: "a",
    steps: `
        <strong>Resolució:</strong>
        <br>
        - La resistència equivalent (\\(R_{eq}\\)) de dues resistències en paral·lel es calcula com:
        \\[
        R_{eq} = \\frac{R_1 \\cdot R_2}{R_1 + R_2}
        \\]
        - El valor nominal de la resistència equivalent és:
        \\[
        R_{eq,nom} = \\frac{20 \\cdot 30}{20 + 30} = \\frac{600}{50} = 12\\,Ω
        \\]
        - Com que ambdues resistències tenen una tolerància del ± 5 %, la resistència equivalent també tindrà una tolerància del ± 5 % (en configuracions de components on tots comparteixen el mateix percentatge d'error, el resultat final manté la mateixa proporció d'error relatiu).
        - Calculem el límit inferior (\\(12\\,Ω - 5\\,\\%\\)):
        \\[
        R_{min} = 12 \\cdot (1 - 0,05) = 12 \\cdot 0,95 = 11,40\\,Ω
        \\]
        - Calculem el límit superior (\\(12\\,Ω + 5\\,\\%\\)):
        \\[
        R_{max} = 12 \\cdot (1 + 0,05) = 12 \\cdot 1,05 = 12,60\\,Ω
        \\]
        <br>
        La resposta correcta és la <strong>a)</strong>.`,
},
    ...
    type: "questions",
    category: "mecanica",
    text: `<br>Es disposa d’un cilindre d’efecte simple que treballa a \\(0,7\\,\\text{MPa}\\). El diàmetre de l’èmbol és de \\(40\\,\\text{mm}\\) i el diàmetre de la tija és de \\(25\\,\\text{mm}\\). Quina força teòrica fa el cilindre en el procés d’avanç?
    <br><br>
    <strong>a)</strong> 536,0 N
    <br>
    <strong>b)</strong> 343,6 N
    <br>
    <strong>c)</strong> 123,7 N
    <br>
    <strong>d)</strong> 879,6 N
    <br><br>`,
    correctAnswer: "d",
    steps: `
        <strong>Resolució:</strong>
        <br>
        - En un cilindre d'efecte simple, la força d'avanç es produeix quan l'aire (o fluid) actua sobre tota la cara de l'èmbol. El diàmetre de la tija no influeix en la força d'avanç, ja que la pressió s'aplica a la cara oposada.
        - Calculem l'àrea de l'èmbol (\\(A\\)) amb el diàmetre de \\(40\\,\\text{mm} = 0,04\\,\\text{m}\\):
        \\[
        A = \\frac{π \\cdot d^2}{4} = \\frac{π \\cdot 0,04^2}{4} = 1,2566 \\times 10^{-3}\\,\\text{m}^2
        \\]
        - La pressió de treball és \\(0,7\\,\\text{MPa} = 0,7 \\times 10^6\\,\\text{Pa}\\).
        - Calculem la força teòrica (\\(F = p \\cdot A\\)):
        \\[
        F = 0,7 \\times 10^6\\,\\text{Pa} \\cdot 1,2566 \\times 10^{-3}\\,\\text{m}^2 = 879,62\\,\\text{N}
        \\]
        <br>
        La resposta correcta és la <strong>d)</strong>.`,
},
    ...
    type: "questions",
    category: "energia",
    text: `<br>Un motor de quatre temps consumeix \\(9,5\\,\\text{L/h}\\) d’un combustible de densitat \\(0,85\\,\\text{kg/dm}^3\\) i poder calorífic \\(p_c = 44,8\\,\\text{MJ/kg}\\). En el cas que s’analitza, proporciona un parell de \\(87\\,\\text{N m}\\) quan gira a \\(3\\,000\\,\\text{min}^{-1}\\). Quin és el rendiment del motor?
    <br><br>
    <strong>a)</strong> 16,32 %
    <br>
    <strong>b)</strong> 27,2 %
    <br>
    <strong>c)</strong> 45,33 %
    <br>
    <strong>d)</strong> 75,55 %
    <br><br>`,
    correctAnswer: "b",
    steps: `
        <strong>Resolució:</strong>
        <br>
        - Primer calculem la potència útil (\\(P_u\\)) a partir del parell (\\(Γ\\)) i la velocitat angular (\\(ω\\)):
        \\[
        ω = 3000 \\cdot \\frac{2π}{60} = 100π\\,\\text{rad/s}
        \\]
        \\[
        P_u = Γ \\cdot ω = 87\\,\\text{N m} \\cdot 100π\\,\\text{rad/s} = 27331,85\\,\\text{W} = 27,33\\,\\text{kW}
        \\]
        - Ara calculem la potència absorbida o consumida (\\(P_c\\)) a partir del consum de combustible. Primer trobem el cabal de massa (\\(1\\,\\text{dm}^3 = 1\\,\\text{L}\\)):
        \\[
        q_m = 9,5\\,\\text{L/h} \\cdot 0,85\\,\\text{kg/L} = 8,075\\,\\text{kg/h} = 0,002243\\,\\text{kg/s}
        \\]
        \\[
        P_c = q_m \\cdot p_c = 0,002243\\,\\text{kg/s} \\cdot 44,8 \\cdot 10^6\\,\\text{J/kg} = 100488,89\\,\\text{W} = 100,49\\,\\text{kW}
        \\]
        - Finalment, calculem el rendiment (\\(η\\)):
        \\[
        η = \\frac{P_u}{P_c} = \\frac{27,33}{100,49} = 0,2719 \\approx 27,2\\,\\%
        \\]
        <br>
        La resposta correcta és la <strong>b)</strong>.`,
},
    ...
    type: "questions",
    category: "energia",
    text: `<br>Un motor eleva una barrera de pàrquing homogènia de longitud \\(l = 1,5\\,\\text{m}\\) i massa \\(m = 3\\,\\text{kg}\\), des de la posició horitzontal (barrera tancada) fins a la vertical. L’energia mecànica necessària per a fer aquest moviment:
    <br><br>
    <strong>a)</strong> és nuŀla.
    <br>
    <strong>b)</strong> és 22,07 J.
    <br>
    <strong>c)</strong> és 44,13 J.
    <br>
    <strong>d)</strong> depèn de la velocitat de gir de la barrera.
    <br><br>`,
    correctAnswer: "b",
    steps: `
        <strong>Resolució:</strong>
        <br>
        - L'energia mecànica mínima necessària per elevar la barrera equival al canvi en la seva energia potencial gravitatòria (\\(ΔE_p = m \\cdot g \\cdot Δh\\)).
        - En una barra homogènia, tota la massa es considera concentrada en el seu centre de gravetat (cdg), que es troba a la meitat de la seva longitud (\\(l/2\\)).
        - En posició horitzontal, l'altura del cdg és \\(h_0 = 0\\).
        - En posició vertical, l'altura del cdg és \\(h_f = l/2 = 1,5 / 2 = 0,75\\,\\text{m}\\).
        - Per tant, el desplaçament vertical del cdg és \\(Δh = 0,75\\,\\text{m}\\).
        - Calculem l'energia:
        \\[
        E = m \\cdot g \\cdot Δh = 3\\,\\text{kg} \\cdot 9,81\\,\\text{m/s}^2 \\cdot 0,75\\,\\text{m} = 22,0725\\,\\text{J}
        \\]
        <br>
        La resposta correcta és la <strong>b)</strong>.`,
},
    ...
    type: "questions",
    category: "energia",
    text: `<br>La bomba d’una depuradora de piscina consumeix \\(1,1\\,\\text{kW}\\) quan bombeja un cabal d’aigua de \\(10\\,\\text{m}^3\\text{/h}\\). La bomba, de rendiment \\(0,7\\), està en funcionament \\(6\\,\\text{hores}\\) al dia d’abril a octubre. Si el preu de l’energia és de \\(0,21578\\,€\\text{/(kWh)}\\), quin és el cost econòmic de tenir la bomba funcionant durant aquests 7 mesos?
    <br><br>
    <strong>a)</strong> 304,8 €
    <br>
    <strong>b)</strong> 213,3 €
    <br>
    <strong>c)</strong> 454,4 €
    <br>
    <strong>d)</strong> 149,3 €
    <br><br>`,
    correctAnswer: "a",
    steps: `
        <strong>Resolució:</strong>
        <br>
        - Primer, calculem el nombre total de dies que la bomba està en funcionament (d'abril a octubre inclosos):
        \\[
        \\text{Abril(30) + Maig(31) + Juny(30) + Juliol(31) + Agost(31) + Setembre(30) + Octubre(31) = 214 dies}
        \\]
        - Calculem les hores totals de funcionament:
        \\[
        t_{total} = 214\\,\\text{dies} \\times 6\\,\\text{h/dia} = 1284\\,\\text{h}
        \\]
        - L'energia consumida total es calcula amb la potència consumida (ja ens donen la potència elèctrica de consum, el rendiment no és necessari per al cost econòmic ja que paguem pel que consumim):
        \\[
        E = P_{consum} \\times t_{total} = 1,1\\,\\text{kW} \\times 1284\\,\\text{h} = 1412,4\\,\\text{kWh}
        \\]
        - Finalment, calculem el cost total multiplicant l'energia pel preu del kWh:
        \\[
        \\text{Cost} = 1412,4\\,\\text{kWh} \\times 0,21578\\,€\\text{/kWh} = 304,769\\,€
        \\]
        - Arrodonint, el valor és 304,8 €.
        <br>
        La resposta correcta és la <strong>a)</strong>.`,
},
    {
    type: "questions",
    category: "mecanica",
    text: `<br>Es vol aixecar una massa \\(m = 750\\,\\text{kg}\\) utilitzant una premsa hidràulica. El diàmetre de l’èmbol gros és \\(D = 900\\,\\text{mm}\\) i el de l’èmbol petit, \\(d = 300\\,\\text{mm}\\). Les resistències passives són negligibles. Si es vol desplaçar \\(20\\,\\text{mm}\\) la càrrega (\\(h_{gros}\\)), quin ha de ser el desplaçament de l’èmbol petit (\\(h_{petit}\\))?
    <br><br>
    <strong>a)</strong> 450 mm
    <br>
    <strong>b)</strong> 222,2 mm
    <br>
    <strong>c)</strong> 180 mm
    <br>
    <strong>d)</strong> 60 mm
    <br><br>`,
    correctAnswer: "c",
    steps: `
        <strong>Resolució:</strong>
        <br>
        - En una premsa hidràulica, el volum de fluid desplaçat per l'èmbol petit ha de ser igual al volum de fluid que rep l'èmbol gros:
        \\[
        V_{petit} = V_{gros} \\implies A_{petit} \\cdot h_{petit} = A_{gros} \\cdot h_{gros}
        \\]
        - Les àrees són proporcionals al quadrat dels diàmetres (\\(A = \\frac{π \\cdot d^2}{4}\\)), per tant:
        \\[
        d^2 \\cdot h_{petit} = D^2 \\cdot h_{gros}
        \\]
        - Aïllem el desplaçament de l'èmbol petit (\\(h_{petit}\\)):
        \\[
        h_{petit} = h_{gros} \\cdot \\frac{D^2}{d^2} = h_{gros} \\cdot \\left(\\frac{D}{d}\\right)^2
        \\]
        - Substituïm els valors:
        \\[
        h_{petit} = 20\\,\\text{mm} \\cdot \\left(\\frac{900}{300}\\right)^2 = 20 \\cdot 3^2 = 20 \\cdot 9 = 180\\,\\text{mm}
        \\]
        <br>
        La resposta correcta és la <strong>c)</strong>.`,
},
    ...
    type: "questions",
    category: "electricitat",
    text: `<br>El fil de la resistència elèctrica d’un calefactor té una resistivitat \\(ρ = 16 \\times 10^{-9}\\,Ω\\text{ m}\\), un diàmetre de \\(0,12\\,\\text{mm}\\) i una longitud de \\(30\\,\\text{m}\\). La potència consumida pel calefactor quan es connecta a una tensió de \\(230\\,\\text{V}\\) és:
    <br><br>
    <strong>a)</strong> 9,919 kW.
    <br>
    <strong>b)</strong> 4,244 kW.
    <br>
    <strong>c)</strong> 2,492 kW.
    <br>
    <strong>d)</strong> 1,246 kW.
    <br><br>`,
    correctAnswer: "d",
    steps: `
        <strong>Resolució:</strong>
        <br>
        - Primer, calculem la secció del fil (\\(S\\)) a partir del diàmetre (\\(d = 0,12\\,\\text{mm} = 1,2 \\times 10^{-4}\\,\\text{m}\\)):
        \\[
        S = \\frac{π \\cdot d^2}{4} = \\frac{π \\cdot (1,2 \\times 10^{-4})^2}{4} = 1,131 \\times 10^{-8}\\,\\text{m}^2
        \\]
        - Calculem la resistència elèctrica (\\(R\\)) del fil amb la llei de Pouillet:
        \\[
        R = ρ \\cdot \\frac{L}{S} = 16 \\times 10^{-9}\\,Ω\\text{m} \\cdot \\frac{30\\,\\text{m}}{1,131 \\times 10^{-8}\\,\\text{m}^2} = 42,44\\,Ω
        \\]
        - Calculem la potència consumida (\\(P\\)) utilitzant la tensió (\\(V = 230\\,\\text{V}\\)):
        \\[
        P = \\frac{V^2}{R} = \\frac{230^2}{42,44} = \\frac{52900}{42,44} = 1246,47\\,\\text{W}
        \\]
        - Convertim a quilowatts:
        \\[
        P = 1,246\\,\\text{kW}
        \\]
        <br>
